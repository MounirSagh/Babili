      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Total Orders */}
            <Card className="bg-gradient-to-r from-teal-500 to-green-500 text-white shadow-lg">
              <CardHeader>
            ...
            {/* Orders by Status */}
            <Card className="bg-gradient-to-r from-white-500 to-withe-500 text-black shadow-lg">
              <CardHeader>
                <CardTitle>Orders by Status</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex space-x-4">
                  <div className="cursor-pointer p-5 rounded-lg text-center w-32 bg-blue-500 text-white">
                    <div className="text-xl font-bold">{approvedOrders}</div>
                    <div>Approved Orders</div>
                  </div>

                  <div className="cursor-pointer p-4 rounded-lg text-center w-32 bg-yellow-500 text-white">
                    <div className="text-xl font-bold">{pendingOrders}</div>
                    <div>Pending Orders</div>
                  </div>

                  <div className="cursor-pointer p-4 rounded-lg text-center w-32 bg-red-500 text-white">
                    <div className="text-xl font-bold">{rejectedOrders}</div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mt-5">
            <Card className="col-span-2 bg-gradient-to-r from-with-500 to-white-600 text-black shadow-lg">
              <CardHeader>
