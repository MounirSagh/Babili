...
//           userId: user?.id, // Ensure userId is passed to the backend
//           ...userDetails,
//         },
//         cartItems,
//       };
...
//       setCartItems([]); // Assuming you are using `useState` to manage cart items
  
//       // Optionally fetch the cart from the backend to confirm it's cleared
//       fetchCart(); // This should set the cart to an empty state
//     } catch (error) {
...
export default function InvoiceOrderPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Refetch the cart to ensure it's empty
      fetchCart();
